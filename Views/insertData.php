        ...
        <form method="post" action="../Controllers/insertDataCheckController.php">
            <fieldset>
                ...
                <div style="text-align: left; margin-top: 10px;">
                    ...
                    <br><br>
                    Salary: <input type="text" name="sal" style="width: 308px;" required>
                    <br><br>
                </div>
                ...
                <div style="text-align: center;">
                    <a href="home.php" style="display: inline-block; padding: 10px 20px; background-color: #6F0047; color: #fff; text-decoration: none; border-radius: 5px;">Back</a>
                </div>
